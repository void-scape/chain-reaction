...
impl Plugin for ParticlePlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(ParticleSpriteHash::default())
            .register_particle_state::<Always>();
    }
}
...
pub trait ParticleState: Component + Default {
...
pub struct EmitterOf(Entity);

#[derive(Component)]
#[require(S)]
pub struct ParticleBundle<S: ParticleState = Always>(Vec<ParticleEmitter>, PhantomData<fn() -> S>);
